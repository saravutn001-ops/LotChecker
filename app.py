...
def read_both_batch_with_ai(pouches, carton_image_base64, product_type, market_type, mode):
    ...
    for idx, item in enumerate(pouches, start=1):
        image_items.append({"id": f"POUCH_{idx}", "check_type": "pouch", "image": item.get("image", "")})
