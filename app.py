...
def normalize_image_base64_for_ai(image_base64, max_side=1000):
    """
...
def enhance_lot_image_for_ai(image_base64, check_type=""):
    ...
    """
    try:
        clean_b64 = normalize_image_base64_for_ai(image_base64, max_side=1000)
        ...
        target_min_w = 1000 if str(check_type).lower() == "carton" else 900
        if w < target_min_w:
            scale = min(1.5, target_min_w / max(1, w))
