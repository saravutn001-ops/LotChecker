...
.table-wrap{overflow-x:auto}.wo-table{width:100%;border-collapse:collapse;font-size:14px;min-width:820px}.wo-table th,.wo-table td{border-bottom:1px solid #e2e8f0;padding:10px;text-align:left;vertical-align:top}.wo-table th{background:#f8fafc;color:#334155}.pill{display:inline-flex;align-items:center;justify-content:center;background:#e0f2fe;color:#075985;border-radius:999px;padding:3px 10px;font-weight:800;font-size:12px;white-space:nowrap;word-break:keep-all;overflow-wrap:normal;min-width:58px;line-height:1.25}.row-actions{display:flex;align-items:center;gap:6px;flex-wrap:nowrap;white-space:nowrap}.row-actions .btn-small{display:inline-flex;align-items:center;justify-content:center;width:auto;min-width:0;white-space:nowrap;padding:8px 10px;margin:0}.wo-table th:last-child,.wo-table td:last-child{min-width:160px}
