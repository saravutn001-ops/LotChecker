...
<style>
:root{--blue:#0b63ce;--dark:#08233f;--bg:#eef5ff;--card:#fff;--border:#dbe5f0;--text:#172033;--muted:#64748b;--green:#16a34a;--red:#dc2626}*{box-sizing:border-box}body{margin:0;font-family:Arial,'Noto Sans Thai',sans-serif;background:linear-gradient(180deg,#eaf4ff,#f8fbff);color:var(--text);padding:12px}.app{max-width:1180px;margin:auto}.header{background:linear-gradient(135deg,#08233f,#0b63ce);color:#fff;border-radius:20px;padding:14px 18px;display:flex;align-items:center;justify-content:space-between;gap:12px;box-shadow:0 12px 30px rgba(8,35,63,.22)}.brand{display:flex;align-items:center;gap:12px}.logo{width:48px;height:48px;border-radius:14px;background:#fff;display:flex;align-items:center;justify-content:center;color:#0b63ce;font-weight:900}.title{font-size:22px;font-weight:900;line-height:1}.subtitle{font-size:12px;color:#dbeafe;margin-top:4px}.pill{background:rgba(255,255,255,.16);border:1px solid rgba(255,255,255,.2);padding:8px 12px;border-radius:999px;font-size:13px;font-weight:700}.grid{display:grid;grid-template-columns:1.05fr .95fr;gap:12px;margin-top:12px}.card{background:var(--card);border:1px solid var(--border);border-radius:20px;padding:14px;box-shadow:0 10px 26px rgba(15,23,42,.08)}.card-title{font-size:16px;font-weight:900;margin:0 0 12px;display:flex;align-items:center;gap:8px}.fields{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:10px}.field label{display:block;font-size:13px;color:#475569;font-weight:800;margin:0 0 6px}.field input,.field select{width:100%;height:46px;border:1px solid var(--border);border-radius:14px;background:#fbfdff;padding:0 12px;font-size:16px;color:var(--text);line-height:46px;appearance:auto}.field input[type=date]{padding-top:0;padding-bottom:0;line-height:46px;min-height:46px}.field input[readonly],.field select:disabled{background:#f1f5f9;color:#64748b}.hidden{display:none!important}.lot-preview{margin-top:12px;padding:12px;border-radius:16px;background:#f8fafc;border:1px dashed #cbd5e1;font-size:14px;line-height:1.55;color:#334155}.photos{display:grid;grid-template-columns:1fr 1fr;gap:12px}.photo-box{border:1px solid var(--border);border-radius:18px;padding:12px;background:#fff}.photo-title{font-weight:900;margin-bottom:4px}.small{font-size:12px;color:var(--muted);line-height:1.45;margin:0 0 8px}.file-input{display:none}.file-btn,.action-btn,button{border:0;border-radius:14px;font-weight:900;cursor:pointer}.file-btn{display:block;text-align:center;background:#eef6ff;color:#0b63ce;border:1px solid #bfdbfe;padding:12px;margin:8px 0}.preview{display:none;width:100%;max-height:280px;object-fit:contain;background:#0f172a;border-radius:14px;border:1px solid var(--border);margin-top:8px}.preview.show{display:block}.capture-time{display:block;font-size:12px;color:#64748b;margin-top:6px}.camera-card{margin-top:12px}.button-row{display:grid;grid-template-columns:1fr 1fr;gap:10px}.action-btn{width:100%;height:52px;font-size:17px;background:linear-gradient(135deg,#0b63ce,#084c9e);color:#fff;box-shadow:0 10px 22px rgba(11,99,206,.2)}.action-btn.green{background:linear-gradient(135deg,#16a34a,#15803d)}.camera-overlay{position:fixed;inset:0;background:#000;z-index:99999;display:none;flex-direction:column}.camera-overlay.show{display:flex}.camera-live{position:relative;flex:1;display:flex;align-items:center;justify-content:center;overflow:hidden}.camera-live video{width:100%;height:100%;object-fit:contain;background:#000}.scan-guide{position:absolute;width:70%;height:24%;left:15%;top:38%;border:3px solid #22c55e;border-radius:14px;box-shadow:0 0 0 9999px rgba(0,0,0,.18)}.camera-tools{background:#111827;padding:12px;display:grid;grid-template-columns:1fr 1fr 1fr;gap:10px}.camera-tools button{height:52px;color:#fff;background:#0b63ce;font-size:16px}.camera-tools .close{background:#ef4444}.toast{position:fixed;top:16px;left:50%;transform:translateX(-50%) translateY(-10px);background:#16a34a;color:#fff;padding:12px 18px;border-radius:14px;font-weight:900;z-index:100000;box-shadow:0 12px 26px rgba(0,0,0,.22);opacity:0;pointer-events:none;transition:.2s}.toast.show{opacity:1;transform:translateX(-50%) translateY(0)}.toast.error{background:#dc2626}.result-popup-overlay{position:fixed;inset:0;background:rgba(15,23,42,.72);z-index:99998;display:none;align-items:center;justify-content:center;padding:14px}.result-popup-overlay.show{display:flex}.result-popup{width:min(980px,100%);max-height:92vh;overflow:auto;background:#fff;border-radius:22px;box-shadow:0 30px 80px rgba(0,0,0,.35)}.popup-header{display:flex;justify-content:space-between;align-items:center;padding:16px 18px;color:#fff}.popup-header.pass{background:#16a34a}.popup-header.ng{background:#dc2626}.popup-title{font-size:28px;font-weight:900}.popup-sub{font-size:13px;opacity:.95}.popup-close{font-size:34px;background:transparent;color:#fff;border:0;width:48px;height:48px;line-height:40px;cursor:pointer}.popup-body{padding:16px}.evidence{display:flex;justify-content:center}.evidence img{width:100%;max-height:58vh;object-fit:contain;border-radius:16px;background:#f8fafc;border:1px solid var(--border)}.lot-box{margin-top:12px;display:grid;grid-template-columns:1fr 1fr;gap:10px}.lot-item{background:#f8fafc;border:1px solid var(--border);border-radius:16px;padding:12px}.lot-label{font-size:12px;color:#64748b;font-weight:800}.lot-value{font-size:15px;font-weight:900;margin-top:4px;word-break:break-word}.ng-list{margin-top:12px}.ng-list table{width:100%;border-collapse:collapse}.ng-list th,.ng-list td{border-bottom:1px solid var(--border);padding:8px;text-align:left;font-size:13px}.ok-box{margin-top:12px;background:#dcfce7;color:#166534;border:1px solid #86efac;border-radius:16px;padding:12px;font-weight:900;text-align:center}.popup-actions{display:grid;grid-template-columns:1fr 1fr 1fr;gap:10px;margin-top:12px}.popup-actions a,.popup-actions button{display:block;text-align:center;text-decoration:none;color:#fff;background:#0f172a;padding:12px;border-radius:14px;font-weight:900;font-size:14px}.popup-actions .line{background:#06c755}.popup-actions .download{background:#16a34a}.result-mini{margin-top:12px}.result-card{border-radius:18px;padding:14px;text-align:center;font-weight:900}.result-card.pass{background:#dcfce7;color:#166534;border:1px solid #86efac}.result-card.ng{background:#fee2e2;color:#991b1b;border:1px solid #fca5a5}.result-card button{margin-top:10px;background:#0b63ce;color:#fff;padding:12px 18px}@media(max-width:760px){body{padding:10px}.header{border-radius:18px;padding:12px}.title{font-size:19px}.pill{display:none}.grid{grid-template-columns:1fr}.fields{grid-template-columns:1fr}.photos{grid-template-columns:1fr}.button-row{grid-template-columns:1fr}.camera-tools{grid-template-columns:1fr;gap:8px}.camera-tools button{height:56px}.lot-box{grid-template-columns:1fr}.popup-actions{grid-template-columns:1fr}.popup-title{font-size:24px}.preview{max-height:360px}.card{padding:12px;border-radius:18px}.field input,.field select{height:48px;line-height:48px;font-size:16px}.evidence img{max-height:50vh}}
</style>
</head>
<body>
<div class="app"><div class="header"><div class="brand"><div class="logo">IP</div><div><div class="title">IP ONE LOT CHECKER</div><div class="subtitle">Pouch + Carton Verification</div></div></div><div class="pill">ตรวจซอง + กล่อง</div></div>
<input type="hidden" id="checkType" value="both"><input type="hidden" id="mfg"><input type="hidden" id="linapackExp"><input type="hidden" id="sachetExp"><input type="hidden" id="sachetLine"><input type="hidden" id="cartonExp">
<div class="grid"><div class="card"><div class="card-title">⚙️ ตั้งค่าข้อมูลการตรวจ</div><div class="fields"><div class="field"><label>ประเภทไลน์</label><select id="mode"><option value="" selected disabled>เลือกประเภทไลน์</option><option value="sachet">Sachet</option><option value="linapack">Linapack</option></select></div><div class="field"><label id="machineHeaderLabel">เครื่อง</label><select id="lpMachine" disabled><option value="" selected>เลือกประเภทไลน์ก่อน</option></select></div><div class="field"><label>ประเภทผลิตภัณฑ์</label><select id="productType"><option value="" selected disabled>เลือกผลิตภัณฑ์</option><option value="EPC">EPC</option><option value="EPW">EPW</option></select></div><div class="field"><label>ประเภทงาน</label><select id="marketType"><option value="" selected disabled>เลือกประเภทงาน</option><option value="TH">งานไทย</option><option value="EXPORT">งานต่างประเทศ</option><option value="LAOS">งานต่างประเทศ ลาว</option></select></div><div class="field"><label>วันที่ผลิต (MFG)</label><input type="date" id="mfgDate"></div><div class="field mix-field hidden"><label>วันที่ผสม</label><input type="date" id="mixDate"></div><div class="field mix-field hidden"><label>Mix Code</label><input id="mixCode" readonly placeholder="Auto เช่น 18F"></div></div><div id="lotPreview" class="lot-preview">กรุณาเลือกข้อมูลให้ครบ</div></div>
<div class="card"><div class="card-title">📦 ข้อมูลล็อตกล่อง</div><div id="cartonTHBox" class="fields hidden"><div class="field"><label>Shipping Mark</label><input value="-" readonly></div><div class="field"><label>Prefix</label><input value="00" readonly></div><div class="field"><label>เลขอาคาร</label><select id="buildingNo"><option value="">ไม่มี</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option></select></div><div class="field"><label>Suffix หลังเลขอาคาร</label><input id="buildingSuffixTH" placeholder="เช่น N หรือ QR"></div></div><div id="cartonExportBox" class="fields hidden"><div class="field"><label>Shipping Mark</label><input id="shippingMark" placeholder="เลือก Prefix" readonly></div><div class="field"><label>Prefix</label><select id="cartonPrefix"><option value="" selected disabled>เลือก Prefix</option><option value="KC">KC → ZZZZZ</option><option value="VN">VN → IPO VN</option><option value="VT">VT → VN-MT</option><option value="KK">KK → AKK</option><option value="CT">CT → CDT</option><option value="TS">TS → TS</option><option value="AC">AC → AKC</option><option value="SM">SM → SOMCHAICHALUEN</option><option value="AX">AX → AKX</option><option value="MM">MM → I.P. ONE-MYANMAR</option><option value="ML">ML → ML</option><option value="KT">KT → KT</option><option value="MW">MW → MWD</option><option value="MK">MK → MK</option><option value="MY">MY → MDY</option><option value="TG">TG → TG</option><option value="MN">MN → MNJM</option><option value="MA">MA → MLA</option><option value="LM">LM → MT/LM+VY</option><option value="DK">DK → DKSH</option><option value="NT">NT → NTPL</option><option value="XR">XR → XR</option><option value="BU">BU → BUL</option><option value="UK">UK → U,K,T-7</option><option value="DB">DB → DBL INDUSTRIES PLC</option><option value="OL">OL → IMPORTER:ORGANIC LINE CO., LTD</option><option value="OD">OD → IMPORTER:ORGANIC LINE CO., LTD</option><option value="MI">MI → ZZZZZ</option><option value="WD">WD → WEDAR</option><option value="CZ">CZ → ZZZZZ</option><option value="ND">ND → NDF</option><option value="CS">CS → CSMS</option><option value="FN">FN → FENIX</option><option value="CD">CD → CDM</option><option value="DT">DT → DBT</option><option value="YP">YP → YPG</option><option value="LB">LB → ZZZZZ</option><option value="LQ">LQ → ZZZZZ</option><option value="CUSTOM">CUSTOM → กรอกเอง</option></select></div><div class="field"><label>เลขอาคาร</label><select id="buildingNoExport"><option value="">ไม่มี</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option></select></div><div class="field"><label>Suffix หลังเลขอาคาร</label><input id="buildingSuffixExport" placeholder="เช่น N หรือ QR"></div></div><div id="cartonHint" class="lot-preview">เลือกประเภทงานเพื่อแสดงข้อมูลล็อตกล่อง</div></div></div>
<div class="card" style="margin-top:12px"><div class="card-title">🖼️ รูปตรวจสอบ</div><div class="photos"><div class="photo-box"><div class="photo-title">รูปซอง</div><p class="small">เลือกไฟล์จากเครื่อง หรือเปิดกล้องเพื่อถ่าย</p><input class="file-input" type="file" id="fileInputPouch" accept="image/*"><label class="file-btn" for="fileInputPouch">📁 เลือกไฟล์รูปซอง</label><img id="previewPouch" class="preview"><span id="pouchCaptureTime" class="capture-time"></span></div><div class="photo-box"><div class="photo-title">รูปกล่อง</div><p class="small">เลือกไฟล์จากเครื่อง หรือเปิดกล้องเพื่อถ่าย</p><input class="file-input" type="file" id="fileInputCarton" accept="image/*"><label class="file-btn" for="fileInputCarton">📁 เลือกไฟล์รูปกล่อง</label><img id="previewCarton" class="preview"><span id="cartonCaptureTime" class="capture-time"></span></div></div><div class="button-row camera-card"><button class="action-btn" id="openCameraBtn" type="button">เปิดกล้อง</button><button class="action-btn green" id="checkBtn" type="button">ตรวจสอบล็อตซอง + กล่อง</button></div></div><div id="result" class="result-mini"></div></div>
<div id="cameraOverlay" class="camera-overlay"><div class="camera-live"><video id="video" autoplay playsinline muted></video><div class="scan-guide"></div></div><div class="camera-tools"><button type="button" id="capturePouchBtn">ถ่ายรูปซอง</button><button type="button" id="captureCartonBtn">ถ่ายรูปกล่อง</button><button type="button" class="close" id="closeCameraBtn">ปิดกล้อง</button></div><canvas id="canvas" style="display:none"></canvas></div><div id="resultPopup" class="result-popup-overlay"><div class="result-popup"><div id="resultPopupContent"></div></div></div><div id="captureToast" class="toast"></div>
<script>
let pouchImageData="",cartonImageData="",cameraStream=null,latestResultPopupHtml="",latestShareResultText="PASS";const $=id=>document.getElementById(id);const PREFIX_SHIPPING_MAP={KC:"ZZZZZ",VN:"IPO VN",VT:"VN-MT",KK:"AKK",CT:"CDT",TS:"TS",AC:"AKC",SM:"SOMCHAICHALUEN",AX:"AKX",MM:"I.P. ONE-MYANMAR",ML:"ML",KT:"KT",MW:"MWD",MK:"MK",MY:"MDY",TG:"TG",MN:"MNJM",MA:"MLA",LM:"MT/LM+VY",DK:"DKSH",NT:"NTPL",XR:"XR",BU:"BUL",UK:"U,K,T-7",DB:"DBL INDUSTRIES PLC",OL:"IMPORTER:ORGANIC LINE CO., LTD",OD:"IMPORTER:ORGANIC LINE CO., LTD",MI:"ZZZZZ",WD:"WEDAR",CZ:"ZZZZZ",ND:"NDF",CS:"CSMS",FN:"FENIX",CD:"CDM",DT:"DBT",YP:"YPG",LB:"ZZZZZ",LQ:"ZZZZZ"};const MIX_MONTH_CODES=["A","B","C","D","E","F","G","H","I","J","K","L"];function showToast(msg,type="success"){const t=$("captureToast");t.textContent=msg;t.className="toast show"+(type==="error"?" error":"");clearTimeout(window.toastTimer);window.toastTimer=setTimeout(()=>t.classList.remove("show"),2400)}function setMachineOptions(){const mode=$("mode").value,m=$("lpMachine");m.innerHTML="";if(!mode){m.disabled=true;m.innerHTML='<option value="" selected>เลือกประเภทไลน์ก่อน</option>';return}m.disabled=false;m.innerHTML='<option value="" selected disabled>เลือกเครื่อง</option>';const opts=mode==="sachet"?["MS1","MS2","MS3","MS4","MS5","MS6","MS7","MS8","MS9","MS10","MS11","MS12","AS1","AS2"]:["LP1","LP2","LP3","LP4","LP5","LP6","LP7","LP8","LP9"];opts.forEach(v=>m.add(new Option(v,v)));$("machineHeaderLabel").textContent=mode==="sachet"?"เครื่อง Sachet":"เครื่อง Linapack"}function syncMfg(){const v=$("mfgDate").value;if(!v){$("mfg").value="";return}const [y,m,d]=v.split("-");$("mfg").value=d+m+y.slice(-2)}function calcExp(){const product=$("productType").value,market=$("marketType").value,mfg=$("mfg").value;if(!/^\d{6}$/.test(mfg))return"";const d=new Date(2000+Number(mfg.slice(4,6)),Number(mfg.slice(2,4))-1,Number(mfg.slice(0,2)));let months=null;if(product==="EPC"&&market==="TH")months=15;if(product==="EPC"&&market==="LAOS")months=24;if(product==="EPW"&&market==="LAOS")months=36;if(months===null)return"";const day=d.getDate();d.setMonth(d.getMonth()+months);if(d.getDate()!==day)d.setDate(0);return String(d.getDate()).padStart(2,"0")+String(d.getMonth()+1).padStart(2,"0")+String(d.getFullYear()).slice(-2)}function updateMix(){const v=$("mixDate").value;if(!v){$("mixCode").value="";return}const [,m,d]=v.split("-");$("mixCode").value=d+(MIX_MONTH_CODES[Number(m)-1]||"")}function updateProductMarketUI(){const product=$("productType").value,market=$("marketType").value,needMix=product==="EPW"&&(market==="TH"||market==="LAOS");document.querySelectorAll(".mix-field").forEach(el=>el.classList.toggle("hidden",!needMix));if(!needMix){$("mixDate").value="";$("mixCode").value=""}$("cartonTHBox").classList.toggle("hidden",market!=="TH");$("cartonExportBox").classList.toggle("hidden",!(market==="EXPORT"||market==="LAOS"));$("cartonHint").classList.toggle("hidden",!!market);updateShippingMark();updatePreviewText()}function updateShippingMark(){const p=$("cartonPrefix").value,s=$("shippingMark");if(p==="CUSTOM"){s.readOnly=false;s.value="";s.placeholder="กรอก Shipping Mark เอง"}else{s.readOnly=true;s.value=p?(PREFIX_SHIPPING_MAP[p]||""):"";s.placeholder=p?"":"เลือก Prefix"}updatePreviewText()}function updatePreviewText(){syncMfg();updateMix();const mode=$("mode").value,market=$("marketType").value,mfg=$("mfg").value,machine=$("lpMachine").value,exp=calcExp(),mix=$("mixCode").value;$("linapackExp").value=exp;$("sachetExp").value=exp;if(mode==="sachet")$("sachetLine").value=machine;let pouch="-";if(mfg&&machine){pouch=mode==="sachet"?`MFG ${mfg} ${machine} 1${exp?` EXP ${exp}`:""}`:`MFG ${mfg}${mix?` ${mix}`:""} ${machine} เวลา${exp?` / EXP ${exp}`:""}`}let carton="-";if(mfg&&market==="TH")carton=`00001 00 ${mfg} ${$("buildingNo").value||""}${$("buildingSuffixTH").value?" "+$("buildingSuffixTH").value.toUpperCase():""}`.trim();if(mfg&&(market==="EXPORT"||market==="LAOS")){const p=$("cartonPrefix").value,sm=$("shippingMark").value,b=$("buildingNoExport").value,s=$("buildingSuffixExport").value.toUpperCase();carton=`${sm||""} 00001 ${p||""} ${mfg} ${b||""}${s?" "+s:""}`.trim()}$("lotPreview").innerHTML=`<b>Lot ซองที่ควรเป็น:</b> ${pouch}<br><b>Lot กล่องที่ควรเป็น:</b> ${carton}`}function setImage(kind,data){const isC=kind==="carton",img=$(isC?"previewCarton":"previewPouch");if(isC)cartonImageData=data;else pouchImageData=data;img.src=data;img.classList.add("show");$(isC?"cartonCaptureTime":"pouchCaptureTime").textContent="บันทึกล่าสุด: "+new Date().toLocaleTimeString("th-TH",{hour12:false})}function handleFile(kind,e){const f=e.target.files&&e.target.files[0];if(!f)return;const r=new FileReader();r.onload=ev=>{setImage(kind,ev.target.result);showToast(kind==="carton"?"✅ เลือกรูปกล่องเรียบร้อย":"✅ เลือกรูปซองเรียบร้อย")};r.readAsDataURL(f)}async function startCamera(){try{const video=$("video");if(cameraStream)stopCamera();cameraStream=await navigator.mediaDevices.getUserMedia({audio:false,video:{facingMode:{ideal:"environment"},width:{ideal:1920},height:{ideal:1080}}});video.srcObject=cameraStream;await video.play();$("cameraOverlay").classList.add("show")}catch(e){showToast("เปิดกล้องไม่ได้: "+e.message,"error")}}function stopCamera(){if(cameraStream){cameraStream.getTracks().forEach(t=>t.stop());cameraStream=null}$("video").srcObject=null;$("cameraOverlay").classList.remove("show")}function capture(kind){const v=$("video"),c=$("canvas");if(!v.videoWidth){showToast("กรุณาเปิดกล้องก่อน","error");return}c.width=v.videoWidth;c.height=v.videoHeight;c.getContext("2d").drawImage(v,0,0,c.width,c.height);setImage(kind,c.toDataURL("image/jpeg",.92));showToast(kind==="carton"?"✅ บันทึกรูปกล่องเรียบร้อย":"✅ บันทึกรูปซองเรียบร้อย")}function validate(){syncMfg();updateMix();const missing=[];if(!$("mode").value)missing.push("ประเภทไลน์");if(!$("lpMachine").value)missing.push("เครื่อง");if(!$("productType").value)missing.push("ผลิตภัณฑ์");if(!$("marketType").value)missing.push("ประเภทงาน");if(!$("mfg").value)missing.push("วันที่ผลิต");const product=$("productType").value,market=$("marketType").value;if(product==="EPW"&&(market==="TH"||market==="LAOS")&&!$("mixCode").value)missing.push("วันที่ผสม");if((market==="EXPORT"||market==="LAOS")&&!$("cartonPrefix").value)missing.push("Prefix");if(!pouchImageData)missing.push("รูปซอง");if(!cartonImageData)missing.push("รูปกล่อง");if(missing.length){showToast("กรุณาเลือก/ใส่: "+missing.join(", "),"error");return false}return true}async function sendCheck(){if(!validate())return;$("result").innerHTML='<div class="result-card">กำลังตรวจสอบ...</div>';const market=$("marketType").value,prefix=$("cartonPrefix").value;const payload={checkType:"both",mode:$("mode").value,productType:$("productType").value,marketType:market,mfg:$("mfg").value,line:$("lpMachine").value,exp:calcExp(),mixCode:$("mixCode").value,pouchImage:pouchImageData,cartonImage:cartonImageData,image:pouchImageData,buildingNo:market==="TH"?$("buildingNo").value:$("buildingNoExport").value,buildingSuffix:market==="TH"?$("buildingSuffixTH").value.toUpperCase():$("buildingSuffixExport").value.toUpperCase(),shippingMark:(market==="EXPORT"||market==="LAOS")?$("shippingMark").value:"",cartonAlphaCode:(market==="EXPORT"||market==="LAOS")?prefix:"00"};try{const res=await fetch("/check",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(payload)});const data=await res.json();if(!res.ok||data.error)throw new Error(data.error||"ตรวจสอบไม่สำเร็จ");showResult(data)}catch(e){$("result").innerHTML=`<div class="result-card ng">ERROR<br>${e.message}</div>`;showToast(e.message,"error")}}function showResult(data){const pass=data.summary==="PASS";latestShareResultText=data.summary||"-";const ng=(data.details||[]).filter(x=>x.status==="NG");let ngHtml=ng.length?`<div class="ng-list"><table><tr><th>รายการ NG</th><th>อ่านได้</th><th>ควรเป็น</th></tr>${ng.map(r=>`<tr><td>${r.item||""}</td><td>${r.actual||""}</td><td>${r.expected||""}</td></tr>`).join("")}</table></div>`:`<div class="ok-box">✓ ไม่พบรายการ NG</div>`;const popup=`<div class="popup-header ${pass?"pass":"ng"}"><div><div class="popup-title">${pass?"PASS ✅":"NG ❌"}</div><div class="popup-sub">${data.time||""}</div></div><button class="popup-close" type="button" onclick="closeResultPopup()">×</button></div><div class="popup-body"><div class="evidence">${data.stampedImageUrl?`<img src="${data.stampedImageUrl}">`:""}</div><div class="lot-box">${data.expectedPouchLot?`<div class="lot-item"><div class="lot-label">Lot ซองที่ควรเป็น</div><div class="lot-value">${data.expectedPouchLot}</div></div>`:""}${data.expectedCartonLot?`<div class="lot-item"><div class="lot-label">Lot กล่องที่ควรเป็น</div><div class="lot-value">${data.expectedCartonLot}</div></div>`:""}</div>${ngHtml}${data.stampedImageUrl?`<div class="popup-actions"><button class="line" type="button" onclick="shareResultImage('${data.stampedImageUrl}')">แชร์รูปเข้า LINE / แอปอื่น</button><a href="${data.stampedImageUrl}" target="_blank">เปิดรูป</a><a class="download" href="${data.stampedImageUrl}" download="Lot_Check_Result.jpg">ดาวน์โหลดรูป</a></div>`:""}</div>`;latestResultPopupHtml=popup;openResultPopup(popup);$("result").innerHTML=`<div class="result-card ${pass?"pass":"ng"}">${pass?"PASS ✅":"NG ❌"}<br><button type="button" onclick="openResultPopup(latestResultPopupHtml)">เปิดผลตรวจอีกครั้ง</button></div>`}function openResultPopup(html){$("resultPopupContent").innerHTML=html;$("resultPopup").classList.add("show")}function closeResultPopup(){$("resultPopup").classList.remove("show")}function shareMessage(){const machine=$("lpMachine").value||"-",result=(latestShareResultText||"-").toUpperCase(),now=new Date(),dd=String(now.getDate()).padStart(2,"0"),mm=String(now.getMonth()+1).padStart(2,"0"),yyyy=now.getFullYear(),hh=String(now.getHours()).padStart(2,"0"),mi=String(now.getMinutes()).padStart(2,"0"),ss=String(now.getSeconds()).padStart(2,"0");return `ไลน์ ${machine} ตรวจสอบความถูกต้องของ Lot แล้ว (${result})\n\nวันที่ ${dd}/${mm}/${yyyy} ${hh}:${mi}:${ss}`}async function shareResultImage(url){try{const abs=new URL(url,location.href).href;const resp=await fetch(abs,{cache:"no-store"});const blob=await resp.blob();const file=new File([blob],"Lot_Check_Result.jpg",{type:blob.type||"image/jpeg"});const text=shareMessage();if(navigator.canShare&&navigator.canShare({files:[file]})&&navigator.share){await navigator.share({title:"IP ONE Lot Check Result",text,files:[file]});return}if(navigator.share){await navigator.share({title:"IP ONE Lot Check Result",text,url:abs});return}const a=document.createElement("a");a.href=abs;a.download="Lot_Check_Result.jpg";document.body.appendChild(a);a.click();a.remove();alert("เครื่องนี้ไม่รองรับการแชร์ตรง ระบบดาวน์โหลดรูปให้แทน\n\n"+text)}catch(e){if(e.name!=="AbortError")alert("แชร์รูปไม่สำเร็จ: "+e.message)}}function bind(){["mode","lpMachine","productType","marketType","mfgDate","mixDate","buildingNo","buildingSuffixTH","buildingNoExport","buildingSuffixExport"].forEach(id=>$(id)?.addEventListener("change",()=>{if(id==="mode")setMachineOptions();updateProductMarketUI()}));$("buildingSuffixTH").addEventListener("input",updatePreviewText);$("buildingSuffixExport").addEventListener("input",updatePreviewText);$("cartonPrefix").addEventListener("change",updateShippingMark);$("shippingMark").addEventListener("input",updatePreviewText);$("fileInputPouch").addEventListener("change",e=>handleFile("pouch",e));$("fileInputCarton").addEventListener("change",e=>handleFile("carton",e));$("openCameraBtn").addEventListener("click",startCamera);$("closeCameraBtn").addEventListener("click",stopCamera);$("capturePouchBtn").addEventListener("click",()=>capture("pouch"));$("captureCartonBtn").addEventListener("click",()=>capture("carton"));$("checkBtn").addEventListener("click",sendCheck);$("resultPopup").addEventListener("click",e=>{if(e.target===$("resultPopup"))closeResultPopup()});setMachineOptions();updateProductMarketUI()}document.addEventListener("DOMContentLoaded",bind);
</script></body></html>
"""
