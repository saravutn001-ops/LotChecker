...
def check():
    try:
        ...
        if check_type == "both":
            ...
            carton_json = {}
            carton_lines = []
            max_workers = min(int(os.getenv("OCR_MAX_WORKERS", "2") or "2"), max(1, len(pouches) + 1))
